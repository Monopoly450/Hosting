...
_RULES = [
    ...
    ("POST",   r"^/api/projects$",                      "Создание проекта"),
    ("PUT",    r"^/api/projects/\d+$",                  "Изменение проекта"),
    ("DELETE", r"^/api/projects/\d+$",                  "Удаление проекта"),
    ("POST",   r"^/api/projects/\d+/members$",          "Добавление участника проекта"),
    ("DELETE", r"^/api/projects/\d+/members/\d+$",      "Исключение участника проекта"),
    ("POST",   r"^/api/projects/assign$",               "Привязка ресурса к проекту"),
    ("POST",   r"^/api/domains$",                       "Добавление своего домена"),
    ("POST",   r"^/api/domains/\d+/verify$",            "Проверка DNS и выпуск сертификата"),
    ("DELETE", r"^/api/domains/\d+$",                   "Удаление своего домена"),
    ("POST",   r"^/api/domains/reapply$",               "Переприменение конфига доменов"),
    ("POST",   r"^/api/registry/provision$",           "Запуск приватного реестра"),
    ("POST",   r"^/api/registry/stop$",                "Остановка приватного реестра"),
    ("DELETE", r"^/api/registry/repositories/.+/tags/", "Удаление образа из реестра"),
